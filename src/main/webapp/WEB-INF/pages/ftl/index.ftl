...
<head>
    ...
    <!--[if lt IE 9]><script src="/resources/js/ie-emulation-modes-warning.js"></script><![endif]-->
...
<div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
        <div class="item active">
            <img src="/resources/image/sunrise.jpg" alt="First slide">
            <div class="container">
                <div class="carousel-caption">
                    <h1>有什么可以帮助到您？${page.pageInfo}</h1>
...
<script src="/resources/jquery/jquery-1.11.2.js"></script>
